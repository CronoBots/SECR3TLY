    ...
    function draw() {
      ...
      sheet.innerHTML =
        ...
        (on.demo ? '<section class="mk-sec mk-demo"><h2 class="mk-h">Démographie</h2><div class="mk-demo-g">' +
          '<div><h3 class="mk-h3">Genre</h3><div class="mk-gender"><span style="width:' + a.female + '%"></span><span style="width:' + a.male + '%"></span><span style="width:' + (a.other || 0) + '%"></span></div><div class="mk-leg"><span><i class="g1"></i>Femmes ' + a.female + ' %</span><span><i class="g2"></i>Hommes ' + a.male + ' %</span>' + (a.other ? '<span><i class="g3"></i>Autre ' + a.other + ' %</span>' : '') + '</div></div>' +
